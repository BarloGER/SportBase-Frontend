      ...
      <div className="about-us">
        ...
        <div className="about-us-Team">
          ...
          <div className="personal-card" id="margin">
            ...
            <p className="about-each">
              ...
              recusandae et inventore veritatis officia. Quibusdam aliquid
              tempora temporibus ab excepturi.
            </p>
          </div>
        ...
        <section className="about-SportBase">
          <p className="our-passion">
            ...
            problem of organizing trainings, locations and game days? The
            ...
            easily create new trainings, adjust or postpone them to avoid being
            left out in the rain when the weather doesn't play along. Whether
            it's a cozy Champions League evening or a barbecue with your
            teammates, no problem. With Sportbase you can plan your next team
            evening in seconds and with the push function you save yourself the
            hassle of sending messages. So everyone is informed and nothing
            stands in the way of the evening. The next away game is coming up
            and you don't have a ride yet? No problem. With Sportbase we can
            help you with this problem as well. SportBase makes your sports life
            easier, so you have more time for the important things. Your Sport
            is our passion
          </p>
        </section>
      </div>
